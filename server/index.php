<html>
    <head>
        <title>Soussidev| Firebase Cloud Messaging</title>
        <meta charset="UTF-8">
    ...
    <body>
        ...
        // optional payload
        $payload = array();
        $payload['Developer:'] = 'Soussi Mohamed';
        $payload['Category'] = 'Android dev';
        $payload['Email'] = 'Soussi.mohamed747@gmail.com';
		
        // notification channel Name
        $channel = isset($_GET['channel_name']) ? $_GET['channel_name'] : '';
        ...
        <div class="container">
            <div class="fl_window">
                <div><h1>Android Firebase Notification</h1></div>
                <br/>
                <?php if ($json != '') { ?>
            ...
            <form class="pure-form pure-form-stacked" method="get">
                <fieldset>
                    ...
                    <div class="form-group">
                            <label for="channel_name">Channel Category:</label>
                            <select name="channel_name" id="channel_name" class="form-control">
